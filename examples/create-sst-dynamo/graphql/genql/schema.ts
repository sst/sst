...
export interface MutationRequest {
  createArticle?: [
    { title: Scalars["String"]; url: Scalars["String"] },
    ArticleRequest
  ];
  __typename?: boolean | number;
  __scalar?: boolean | number;
...
export interface MutationPromiseChain {
  createArticle: (args: {
    ...
    get: <R extends ArticleRequest>(
      request: R,
      defaultValue?: FieldsSelection<Article, R>
    ) => Promise<FieldsSelection<Article, R>>;
  };
}
...
export interface MutationObservableChain {
  createArticle: (args: {
    title: Scalars["String"];
    url: Scalars["String"];
  }) => ArticleObservableChain & {
    get: <R extends ArticleRequest>(
      request: R,
      defaultValue?: FieldsSelection<Article, R>
    ) => Observable<FieldsSelection<Article, R>>;
  };
}

export interface QueryPromiseChain {
  article: (args: { articleID: Scalars["String"] }) => ArticlePromiseChain & {
    get: <R extends ArticleRequest>(
      request: R,
      defaultValue?: FieldsSelection<Article, R>
    ) => Promise<FieldsSelection<Article, R>>;

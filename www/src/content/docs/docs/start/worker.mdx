---
title: Build a Cloudflare API with SST
...
:::tip[View source]
You can [view the source](https://github.com/sst/ion/tree/dev/examples/start-cloudflare) of this example in our repo.
:::
...
Create a `.env` file in your project root with your Cloudflare API token.

```bash title=".env"
CLOUDFLARE_API_TOKEN=aaaaaaaa_aaaaaaaaaaaa_aaaaaaaa
```
...
```bash frame="none"
✔  Complete
   url: https://start-cloudflare-jayair-myworkerscript.sst-15d.workers.dev
```

---
title: Realtime apps in AWS and SST
...
When our chat component loads, it'll create a new connection to our realtime component. Add the following below the imports in `components/chat.tsx`.

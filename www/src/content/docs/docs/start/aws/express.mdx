...
We are going to build an Express app in a container, add an S3 Bucket for file uploads, and deploy it to AWS using SST.
...
Once started, click on **MyService** in the sidebar for your local Express app.

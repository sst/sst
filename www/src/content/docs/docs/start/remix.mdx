...
:::tip[View source]
You can [view the source](https://github.com/sst/ion/tree/dev/examples/start-remix) of this example in our repo.
:::
...
![SST Remix app](../../../../assets/docs/start-remix.png)
...
![Issues in Remix app in SST Console](../../../../assets/docs/issues-in-remix-app-in-the-sst-console.png)

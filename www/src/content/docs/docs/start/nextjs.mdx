...
:::tip[View source]
You can [view the source](https://github.com/sst/ion/tree/dev/examples/start-nextjs) of this example in our repo.
:::
...
![Issues in Next.js app in SST Console](../../../../assets/docs/issues-in-nextjs-app-in-the-sst-console.png)

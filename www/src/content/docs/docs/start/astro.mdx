...
:::tip[View source]
You can [view the source](https://github.com/sst/ion/tree/dev/examples/start-astro) of this example in our repo.
:::
...
![SST Astro site](../../../../assets/docs/start-astro.png)
...
![Issues in Astro site in SST Console](../../../../assets/docs/issues-in-astro-site-in-the-sst-console.png)

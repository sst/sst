...
- Resources that are expensive, like your Postgres cluster.
...
To help with this some SST components come with a `static get` method. These compoents are typically ones that people want to be able to share. Here are some components that have this:

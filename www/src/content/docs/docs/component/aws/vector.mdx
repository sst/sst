...
Optionally, use a different model, like OpenAI's `text-embedding-ada-002`, `text-embedding-3-small`, `text-embedding-3-large` model. You'll need to pass in your OpenAI API key.

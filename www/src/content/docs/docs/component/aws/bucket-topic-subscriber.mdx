---
title: BucketTopicSubscriber
description: Reference doc for the `sst.aws.BucketTopicSubscriber` component.
---

{/* DO NOT EDIT. AUTO-GENERATED FROM "platform/src/components/aws/bucket-topic-subscriber.ts" */}
...
<Section type="parameters">
<InlineSection>
**Type** [<code class="type">TopicPolicy</code>](https://www.pulumi.com/registry/packages/aws/api-docs/sns/topicpolicy/)
</InlineSection>
</Section>

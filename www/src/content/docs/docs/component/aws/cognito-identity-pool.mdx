...
{/* DO NOT EDIT. AUTO-GENERATED FROM "platform/src/components/aws/cognito-identity-pool.ts" */}
...
<Section type="signature">
```ts
CognitoIdentityPool.get(name, identityPoolID)
```
</Section>
...
- <p><code class="key">identityPoolID</code> <code class="primitive">Input</code><code class="symbol">&lt;</code><code class="primitive">string</code><code class="symbol">&gt;</code></p>
The ID of the existing Identity Pool.
</Section>

<InlineSection>
**Returns** [<code class="type">CognitoIdentityPool</code>](.)
</InlineSection>

---
title: ApiGatewayV2UrlRoute
description: Reference doc for the `sst.aws.ApiGatewayV2UrlRoute` component.
---

{/* DO NOT EDIT. AUTO-GENERATED FROM "platform/src/components/aws/apigatewayv2-url-route.ts" */}

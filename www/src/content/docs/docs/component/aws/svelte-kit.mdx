---
title: SvelteKit
description: Reference doc for the `sst.aws.SvelteKit` component.
---

{/* DO NOT EDIT. AUTO-GENERATED FROM "platform/src/components/aws/svelte-kit.ts" */}
...
- <p><code class="key">args?</code> [<code class="type">SvelteKitArgs</code>](#sveltekitargs)</p>

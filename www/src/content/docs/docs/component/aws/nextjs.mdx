...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">Input</code><code class="symbol">&lt;</code><code class="primitive">[AssetsProps](#assetsprops)</code><code class="symbol">&gt;</code>
</InlineSection>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">Input</code><code class="symbol">&lt;</code><code class="primitive">string</code><code class="symbol"> | </code><code class="primitive">[DomainProps](#domainprops)</code><code class="symbol">&gt;</code>
</InlineSection>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">[ExperimentalProps](#experimentalprops)</code>
</InlineSection>
</Section>
</Segment>
<Segment>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">[ImageOptimizationProps](#imageoptimizationprops)</code>
</InlineSection>
</Section>
</Segment>
<Segment>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">Input</code><code class="symbol">&lt;</code><code class="primitive">[InvalidationProps](#invalidationprops)</code><code class="symbol">&gt;</code>
</InlineSection>
</Section>
</Segment>
<Segment>
...
- <p><code class="key">plan.cloudFrontFunctions?</code><code class="primitive">Record</code><code class="symbol">&lt;</code><code class="primitive">string</code>, <code class="primitive">Object</code><code class="symbol">&gt;</code></p>
- <p><code class="key">plan.cloudFrontFunctions.injections?</code><code class="primitive">string</code><code class="symbol">[]</code></p>
- <p><code class="key">plan.edge?</code><code class="primitive">boolean</code></p>
- <p><code class="key">plan.edgeFunctions?</code><code class="primitive">Record</code><code class="symbol">&lt;</code><code class="primitive">string</code>, <code class="primitive">Object</code><code class="symbol">&gt;</code></p>
- <p><code class="key">plan.edgeFunctions.function?</code>[<code class="type">FunctionArgs</code>](#functionargs)</p>
...
- <p><code class="key">plan.origins.function?</code>[<code class="type">FunctionArgs</code>](#functionargs)</p>
- <p><code class="key">plan.origins.injections?</code><code class="primitive">string</code><code class="symbol">[]</code></p>
- <p><code class="key">plan.origins.streaming?</code><code class="primitive">boolean</code></p>
- <p><code class="key">plan.origins.type?</code><code class="primitive">function</code></p>
- <p><code class="key">plan.origins.function?</code>[<code class="type">FunctionArgs</code>](#functionargs)</p>
- <p><code class="key">plan.origins.type?</code><code class="primitive">image-optimization-function</code></p>
- <p><code class="key">plan.origins.copy?</code><code class="primitive">Object</code><code class="symbol">[]</code></p>
- <p><code class="key">plan.origins.copy.cached?</code><code class="primitive">boolean</code></p>
- <p><code class="key">plan.origins.copy.from?</code><code class="primitive">string</code></p>
- <p><code class="key">plan.origins.copy.to?</code><code class="primitive">string</code></p>
- <p><code class="key">plan.origins.copy.versionedSubDir?</code><code class="primitive">string</code></p>
- <p><code class="key">plan.origins.originPath?</code><code class="primitive">string</code></p>
- <p><code class="key">plan.origins.type?</code><code class="primitive">s3</code></p>
- <p><code class="key">plan.origins.fallbackOriginName?</code><code class="primitive">string</code></p>
- <p><code class="key">plan.origins.fallbackStatusCodes?</code><code class="primitive">number</code><code class="symbol">[]</code></p>
- <p><code class="key">plan.origins.primaryOriginName?</code><code class="primitive">string</code></p>
- <p><code class="key">plan.origins.type?</code><code class="primitive">group</code></p>

...
<InlineSection>
**Returns** [<code class="type">DynamoSubscriber</code>](#dynamosubscriber)
</InlineSection>
...
<Section type="signature">
```ts
subscribe(streamArn, subscriber, args?)
```
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">Output</code><code class="symbol">&lt;</code>[<code class="type">EventSourceMapping</code>](https://www.pulumi.com/registry/packages/aws/api-docs/lambda/eventsourcemapping/)<code class="symbol">&gt;</code>
</InlineSection>
</Section>

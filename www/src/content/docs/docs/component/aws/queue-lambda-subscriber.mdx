---
title: QueueLambdaSubscriber
description: Reference doc for the `sst.aws.QueueLambdaSubscriber` component.
---

{/* DO NOT EDIT. AUTO-GENERATED FROM "pkg/platform/src/components/aws/queue-lambda-subscriber.ts" */}
...
- <p>[<code class="key">arn</code>](#queue-arn)</p>
</Section>
The queue to use.

</Segment>
<NestedTitle id="queue-arn" Tag="h4" parent="queue.">arn</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>

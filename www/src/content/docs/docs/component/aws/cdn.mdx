...
{/* DO NOT EDIT. AUTO-GENERATED FROM "platform/src/components/aws/cdn.ts" */}
...
- <p>[<code class="key">token?</code>](#invalidation-token)</p>
...
<NestedTitle id="invalidation-token" Tag="h4" parent="invalidation.">token?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">Input</code><code class="symbol">&lt;</code><code class="primitive">string</code><code class="symbol">&gt;</code>

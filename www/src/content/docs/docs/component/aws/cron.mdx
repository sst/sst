...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">Transform</code><code class="symbol">&lt;</code>[<code class="type">EventRuleArgs</code>](https://www.pulumi.com/registry/packages/aws/api-docs/cloudwatch/eventrule/#inputs)<code class="symbol">&gt;</code>
</InlineSection>
</Section>
</Segment>
<Segment>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">Transform</code><code class="symbol">&lt;</code>[<code class="type">EventTargetArgs</code>](https://www.pulumi.com/registry/packages/aws/api-docs/cloudwatch/eventtarget/#inputs)<code class="symbol">&gt;</code>
</InlineSection>
</Section>
</Segment>
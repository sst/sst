---
title: BucketQueueSubscriber
description: Reference doc for the `sst.aws.BucketQueueSubscriber` component.
---

{/* DO NOT EDIT. AUTO-GENERATED FROM "platform/src/components/aws/bucket-queue-subscriber.ts" */}

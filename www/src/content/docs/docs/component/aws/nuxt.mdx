---
title: Nuxt
description: Reference doc for the `sst.aws.Nuxt` component.
---

{/* DO NOT EDIT. AUTO-GENERATED FROM "platform/src/components/aws/nuxt.ts" */}
...
- <p><code class="key">args?</code> [<code class="type">NuxtArgs</code>](#nuxtargs)</p>

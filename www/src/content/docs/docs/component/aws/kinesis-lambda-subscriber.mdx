---
title: KinesisLambdaSubscriber
description: Reference doc for the `sst.aws.KinesisLambdaSubscriber` component.
---

{/* DO NOT EDIT. AUTO-GENERATED FROM "pkg/platform/src/components/aws/kinesis-lambda-subscriber.ts" */}
...
```ts
new KinesisLambdaSubscriber(name, args, opts?)
```
</Section>

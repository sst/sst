...
{/* DO NOT EDIT. AUTO-GENERATED FROM "platform/src/components/aws/apigatewayv2.ts" */}
...
<NestedTitle id="cors-allowcredentials" Tag="h4" parent="cors.">allowCredentials?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
...
- <p>[<code class="key">vpcLink?</code>](#transform-vpclink)</p>
</Section>
...
<NestedTitle id="transform-vpclink" Tag="h4" parent="transform.">vpcLink?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** [<code class="type">VpcLinkArgs</code>](https://www.pulumi.com/registry/packages/aws/api-docs/apigatewayv2/vpclink/#inputs)<code class="symbol"> | </code><code class="symbol">(</code><code class="primitive">args</code><code class="symbol">: </code>[<code class="type">VpcLinkArgs</code>](https://www.pulumi.com/registry/packages/aws/api-docs/apigatewayv2/vpclink/#inputs)<code class="symbol">, </code><code class="primitive">opts</code><code class="symbol">: </code>[<code class="type">ComponentResourceOptions</code>](https://www.pulumi.com/docs/concepts/options/)<code class="symbol">, </code><code class="primitive">name</code><code class="symbol">: </code><code class="primitive">string</code><code class="symbol">)</code><code class="symbol"> => </code><code class="primitive">void</code>
</InlineSection>
</Section>
...
- <p>[<code class="key">vpcLink</code>](#nodes-vpclink)</p>
- <p>[<code class="key">domainName</code>](#nodes-domainname)</p>
</Section>
...
<NestedTitle id="nodes-vpclink" Tag="h4" parent="nodes.">vpcLink</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">undefined</code><code class="symbol"> | </code>[<code class="type">VpcLink</code>](https://www.pulumi.com/registry/packages/aws/api-docs/apigatewayv2/vpclink/)
</InlineSection>
</Section>
The API Gateway HTTP API VPC link.
</Segment>
<NestedTitle id="nodes-domainname" Tag="h4" parent="nodes.">domainName</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** [<code class="type">DomainName</code>](https://www.pulumi.com/registry/packages/aws/api-docs/apigatewayv2/domainname/)
</InlineSection>
</Section>
...
<Section type="parameters">
#### Parameters
- <p><code class="key">rawRoute</code> <code class="primitive">string</code></p>
...
<InlineSection>
**Returns** [<code class="type">ApiGatewayV2PrivateRoute</code>](/docs/component/aws/apigatewayv2-private-route/)
</InlineSection>
...
<InlineSection>
**Returns** [<code class="type">ApiGatewayV2UrlRoute</code>](/docs/component/aws/apigatewayv2-url-route/)
</InlineSection>

...
Configure the [API Gateway logs](https://docs.aws.amazon.com/apigateway/latest/developerguide/view-cloudwatch-log-events-in-cloudwatch-console.html) in CloudWatch. By default, access logs are turned on and kept forever.
...
<Section type="parameters">
<InlineSection>
**Type** [<code class="type">Function</code>](/docs/component/aws/function/)
</InlineSection>
</Section>
The Lambda function.

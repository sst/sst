---
title: ApiGatewayWebSocketLambdaRoute
description: Reference doc for the `sst.aws.ApiGatewayWebSocketLambdaRoute` component.
---

{/* DO NOT EDIT. AUTO-GENERATED FROM "pkg/platform/src/components/aws/apigateway-websocket-lambda-route.ts" */}

...
<Section type="parameters">
<InlineSection>
**Type** <code class="symbol">&ldquo;</code><code class="primitive">audit</code><code class="symbol">&rdquo;</code><code class="symbol"> | </code><code class="symbol">&ldquo;</code><code class="primitive">enforced</code><code class="symbol">&rdquo;</code>
</InlineSection>
</Section>
...
- <p>[<code class="key">preTokenGenerationVersion?</code>](#triggers-pretokengenerationversion)</p>
...
<NestedTitle id="triggers-pretokengenerationversion" Tag="h4" parent="triggers.">preTokenGenerationVersion?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="symbol">&ldquo;</code><code class="primitive">v1</code><code class="symbol">&rdquo;</code><code class="symbol"> | </code><code class="symbol">&ldquo;</code><code class="primitive">v2</code><code class="symbol">&rdquo;</code>
</InlineSection>
</Section>

<InlineSection>
**Default** <code class="primitive">"v1"</code>
</InlineSection>
...
<InlineSection>
**Returns** [<code class="type">CognitoIdentityProvider</code>](/docs/component/aws/cognito-identity-provider/)
</InlineSection>
...
- <p><code class="key">userPoolID</code> <code class="primitive">Input</code><code class="symbol">&lt;</code><code class="primitive">string</code><code class="symbol">&gt;</code></p>
The ID of the existing User Pool.
</Section>

<InlineSection>
**Returns** [<code class="type">CognitoUserPool</code>](.)
</InlineSection>
...
<InlineSection>
**Default** <code class="primitive">["COGNITO"]</code>
</InlineSection>

...
## TransformProps
<InlineSection>
- <p><code class="key">bucket?</code><code class="primitive">Transform</code><code class="symbol">&lt;</code>[<code class="type">BucketV2Args</code>](https://www.pulumi.com/registry/packages/aws/api-docs/s3/bucketv2/#inputs)<code class="symbol">&gt;</code></p>
- <p><code class="key">bucketPolicy?</code><code class="primitive">Transform</code><code class="symbol">&lt;</code>[<code class="type">BucketPolicyArgs</code>](https://www.pulumi.com/registry/packages/aws/api-docs/s3/bucketpolicy/#inputs)<code class="symbol">&gt;</code></p>
</InlineSection>
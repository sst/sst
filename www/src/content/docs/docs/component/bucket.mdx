...
<InlineSection>
**Type** <code class="type">Object</code>
- <p><code class="key">bucket</code> <code class="type">Transform</code><code class="symbol">&lt;</code>[<code class="type">BucketV2Args</code>](https://www.pulumi.com/registry/packages/aws/api-docs/s3/bucketv2args/)<code class="symbol">&gt;</code></p>
- <p><code class="key">bucketPolicy</code> <code class="type">Transform</code><code class="symbol">&lt;</code>[<code class="type">BucketPolicyArgs</code>](https://www.pulumi.com/registry/packages/aws/api-docs/s3/bucketpolicyargs/)<code class="symbol">&gt;</code></p>
</InlineSection>
</Segment>
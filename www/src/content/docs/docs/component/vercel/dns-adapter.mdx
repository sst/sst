...
<InlineSection>
**Returns** <code class="primitive">Output</code><code class="symbol">&lt;</code>[<code class="type">DnsRecord</code>](https://www.pulumi.com/registry/packages/vercel/api-docs/dnsrecord/)<code class="symbol">&gt;</code>
</InlineSection>

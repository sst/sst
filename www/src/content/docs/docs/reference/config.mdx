...
<Section type="parameters">
**Parameters**
- <p><code class="key">input</code> [<code class="type">BranchEvent</code>](#branchevent)<code class="symbol"> | </code>[<code class="type">PullRequestEvent</code>](#pullrequestevent)</p>
</Section>

...
The JS SDK is an [npm package](https://www.npmjs.com/package/sst) that allows you to access linked resources in your functions and frontends in a typesafe way.

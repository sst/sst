...
Manage the telemetry settings.

SST collects completely anonymous telemetry data about general usage. This is completely optional and can be disabled at any time.

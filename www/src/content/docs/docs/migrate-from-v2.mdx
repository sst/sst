...
These were experimental and are not currently supported in v3. To continue using them you can import them by first ading it to your `package.json`.

```js title="package.json"
"sstv2": "npm:sst@2.x.x"
```

And then importing it via the `sstv2` alias.

...
SST v3 uses [Pulumi](https://www.pulumi.com) and [Terraform](https://www.terraform.io). Previously, SST v2 used [CDK and CloudFormation](https://sst.dev/blog/moving-away-from-cdk.html).

:::note
SST is open source, does not require a Pulumi account, and only depends on the open source parts of Pulumi and Terraform.
:::

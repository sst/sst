...
What makes SST different is that your _entire_ app is **defined in code** — in a single `sst.config.ts` file. This includes your databases, buckets, queues, your Stripe webhooks, or anything else you need.
...
But it also supports **any Pulumi or Terraform component** directly in your `sst.config.ts`. This is because components in SST are built on Pulumi components.

For example, you can even use Vercel for your frontends.
...
Read more about [providers](/docs/providers) and check out the full list in the [Pulumi Registry](https://www.pulumi.com/registry/)
...
![SST Console](../../../assets/docs/sst-console-autodeploy.png)

...
SST Ion is a framework that makes it easy to build modern full-stack applications on your own infrastructure.

:::note
Ion currently **only supports Node.js** applications. Support for other languages and runtimes are on the roadmap.
:::
...
Next, you can get started SST Ion with one of our quick starts, like [Next.js](/docs/starts/nextjs/).

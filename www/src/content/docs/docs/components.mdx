...
Components are classes that are name spaced under the cloud provider it deploys to. Currently, Ion supports two providers:

1. AWS
2. Cloudflare

Support for other providers is on the roadmap.

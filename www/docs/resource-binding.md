...
To follow along, you can create a new SST app by running `npx create-sst@two`. Alternatively, you can refer to [this example repo](https://github.com/sst/sst/tree/master/examples/standard-nextjs) that's based on the same template.

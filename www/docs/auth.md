...
Follow along by creating a new SST app by running `npx create-sst@latest`. Alternatively, you can refer to [this example repo](https://github.com/sst/sst/tree/master/examples/standard) that's based on the same template.

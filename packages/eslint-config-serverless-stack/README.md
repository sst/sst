# eslint-config-serverless-stack [![npm](https://img.shields.io/npm/v/eslint-config-serverless-stack.svg?style=flat-square)](https://www.npmjs.com/package/eslint-config-serverless-stack)

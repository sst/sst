...
await fs.cp(
  "support/ssr-site-function-archiver.cjs",
  "dist/support/ssr-site-function-archiver.cjs",
  {
    recursive: true,
  }
);
await esbuild.build({
  ...
  target: "esnext",
  format: "esm",
  entryPoints: ["./support/ssr-site-function-archiver.cjs"],
  banner: {
    js: [
      `import { createRequire as topLevelCreateRequire } from 'module';`,
      `const require = topLevelCreateRequire(import.meta.url);`,
  ...
  outfile: "./dist/support/ssr-site-function-archiver.mjs",
});

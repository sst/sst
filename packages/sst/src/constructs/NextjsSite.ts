...
import { SsrSite, SsrSiteProps, SsrSiteReplaceProps } from "./SsrSite.js";
...
export class NextjsSite extends SsrSite {
  ...
  /**
   * We don't know all of the env vars at build time, so we need to replace the env vars while deploying.
   */
  protected getS3ContentReplaceValues(): SsrSiteReplaceProps[] {
    const replaceValues = super.getS3ContentReplaceValues();

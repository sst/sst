...
type SsrContainerNormalizedProps = SsrContainerProps & {
  architecture: Exclude<SsrContainerProps["architecture"], undefined>;
  cpu: Exclude<SsrContainerProps["cpu"], undefined>;
  path: Exclude<SsrContainerProps["path"], undefined>;
  memory: Exclude<SsrContainerProps["memory"], undefined>;
  port: Exclude<SsrContainerProps["port"], undefined>;
  logRetention: Exclude<SsrContainerProps["logRetention"], undefined>;
};
 ...
 * ```
 */
export class SsrContainer extends Construct implements SSTConstruct {
  public readonly id: string;
  /** @internal */
  public readonly _doNotAllowOthersToBind = true;
  private props: SsrContainerNormalizedProps;
  ...
  constructor(scope: Construct, id: string, props?: SsrContainerProps) {
    super(scope, id);

...
- [`04bdc371e`](https://github.com/sst/sst/commit/04bdc371e6a47768eec10d047b7d816444ff3020) Thanks [@thdxr](https://github.com/thdxr)! - There is a slight breaking change in this release if you are using SST Events with `createEventBuilder()` - you should receive type errors for all the issues. We now support specifying any validation library so will need to configure that.

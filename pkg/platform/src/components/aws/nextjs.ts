...
export interface NextjsArgs extends SsrSiteArgs {
  ...
  /**
   * The version of [OpenNext](https://open-next.js.org) used to build the Next.js app.
   *
...
if (event.rawPath) {
  ...
  /**
   * he autogenerated CloudFront URL of the Next.js app.
   */
  public get url() {
    return this.cdn.url;
  }
  ...
  /**
   * If the `domain` is set, then this is the URL of the Next.js app with the
   * custom domain.
   */

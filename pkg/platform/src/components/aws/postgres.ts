...
export interface PostgresArgs {
   ...
   * :::
   *
   * An ACU or Aurora Capacity Unit is a combination of CPU and RAM. In Aurora Serverless v2, you cannot scale down to 0. The cost of an Aurora Serverless v2 cluster is based on the ACU hours
